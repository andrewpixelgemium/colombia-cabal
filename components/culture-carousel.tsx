    ...
    <div className="py-12 md:py-16 lg:py-20">
      <Card className="relative overflow-hidden border-4 border-red-600 rounded-xl bg-white shadow-lg max-w-5xl mx-auto">
        <Image
          ...
          alt="Colombian President at TGE of $CCC"
          width={1200}
          height={600}
          className="aspect-[2/1] object-cover"
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-black/20 w-full h-full" />
        ...
        <div className="absolute bottom-0 left-0 p-6 text-white">
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl mb-2">
            Colombian President Embraces $CCC
          </h2>
          <p className="text-xl md:text-2xl font-semibold">
            "Our offical ticker is $CCC," says leader in passionate address
          </p>
        </div>
